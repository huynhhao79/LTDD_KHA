...
class _choilaiState extends State<choilai2> {
  @override
  ...
  Future<void> _updateman() async {
    ...
    if (userDoc.exists) {
      ...
      final lastHighscore = user['man3'];

      if (lastHighscore >= widget.score) {
        return;
      }
      userRef.update({'man3': widget.score});
      return;
    }
