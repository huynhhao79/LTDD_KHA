...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh6.dart';
...
class xahoi6 extends StatefulWidget {
  const xahoi6({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi6> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi6> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 30;
