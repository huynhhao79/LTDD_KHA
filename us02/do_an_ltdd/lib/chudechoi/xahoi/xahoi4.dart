...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh4.dart';
...
class xahoi4 extends StatefulWidget {
  const xahoi4({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi4> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi4> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 20;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 26) {
