...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh5.dart';
...
class xahoi5 extends StatefulWidget {
  const xahoi5({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi5> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi5> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 25;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 21) {
