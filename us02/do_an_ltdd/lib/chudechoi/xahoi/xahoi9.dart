...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh9.dart';
...
class xahoi9 extends StatefulWidget {
  const xahoi9({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi9> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi9> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 45;
