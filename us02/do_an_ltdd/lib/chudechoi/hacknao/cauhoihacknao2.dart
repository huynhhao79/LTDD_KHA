...
import 'package:phan4_bai1/chudechoi/hacknao/choilaiii/hn2.dart';
...
class cauhoihacknao2 extends StatefulWidget {
  const cauhoihacknao2(
  ...
  @override
  State<cauhoihacknao2> createState() => _cauhoihacknao2State();
}

class _cauhoihacknao2State extends State<cauhoihacknao2> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 10;
