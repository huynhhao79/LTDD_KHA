...
import 'package:phan4_bai1/chudechoi/hacknao/choilaiii/hn3.dart';
...
class cauhoihacknao3 extends StatefulWidget {
  const cauhoihacknao3(
  ...
  @override
  State<cauhoihacknao3> createState() => _cauhoihacknao2State();
}

class _cauhoihacknao2State extends State<cauhoihacknao3> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 15;
