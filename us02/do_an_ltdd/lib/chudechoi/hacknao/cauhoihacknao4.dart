...
class cauhoihacknao4 extends StatefulWidget {
  const cauhoihacknao4(
  ...
  @override
  State<cauhoihacknao4> createState() => _cauhoihacknao2State();
}

class _cauhoihacknao2State extends State<cauhoihacknao4> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 20;
