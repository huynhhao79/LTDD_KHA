...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh3.dart';
...
class xahoi3 extends StatefulWidget {
  const xahoi3({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi3> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi3> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 15;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 31) {
