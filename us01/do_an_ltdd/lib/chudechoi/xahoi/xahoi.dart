...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh.dart';
...
class xahoi extends StatefulWidget {
  const xahoi({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 0;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 46) {
