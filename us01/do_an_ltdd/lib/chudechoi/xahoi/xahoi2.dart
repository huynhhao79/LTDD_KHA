...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh2.dart';
...
class xahoi2 extends StatefulWidget {
  const xahoi2({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi2> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi2> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 10;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 36) {
