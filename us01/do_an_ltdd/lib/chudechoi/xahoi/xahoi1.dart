...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh1.dart';
...
class xahoi1 extends StatefulWidget {
  const xahoi1({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi1> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi1> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 5;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 41) {
