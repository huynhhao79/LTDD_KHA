...
import 'package:phan4_bai1/chudechoi/xahoi/choilaij/xh8.dart';
...
class xahoi8 extends StatefulWidget {
  const xahoi8({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<xahoi8> createState() => _xahoiState();
}

class _xahoiState extends State<xahoi8> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 40;
