...
import 'package:phan4_bai1/chudechoi/hacknao/choilaiii/hn.dart';
...
class cauhoihacknao extends StatefulWidget {
  const cauhoihacknao(
  ...
  @override
  State<cauhoihacknao> createState() => _cauhoihacknaoState();
}

class _cauhoihacknaoState extends State<cauhoihacknao> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 0;
