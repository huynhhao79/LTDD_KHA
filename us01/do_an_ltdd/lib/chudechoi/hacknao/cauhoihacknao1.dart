...
import 'package:phan4_bai1/chudechoi/hacknao/choilaiii/hn1.dart';
...
class cauhoihacknao1 extends StatefulWidget {
  const cauhoihacknao1(
  ...
  @override
  State<cauhoihacknao1> createState() => _cauhoihacknao1State();
}

class _cauhoihacknao1State extends State<cauhoihacknao1> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 5;
