...
import 'package:phan4_bai1/chudechoi/toanhoc/choilai3.dart';
...
class cauhoi3 extends StatefulWidget {
  const cauhoi3({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi3> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi3> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 15;
