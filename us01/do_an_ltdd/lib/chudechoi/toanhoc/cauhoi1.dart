...
import 'package:phan4_bai1/chudechoi/toanhoc/choilai1.dart';
...
class cauhoi1 extends StatefulWidget {
  const cauhoi1({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi1> createState() => _cauhoi1State();
}

class _cauhoi1State extends State<cauhoi1> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 5;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 11) {
