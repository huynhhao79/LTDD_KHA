...
import 'package:phan4_bai1/chudechoi/toanhoc/choilai2.dart';
...
class cauhoi2 extends StatefulWidget {
  const cauhoi2({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi2> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi2> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 10;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 6) {
